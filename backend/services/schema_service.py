...
from models.schemas import ScrapedDataDict, DatabaseSchemaDict
...
class SchemaService:
    ...
    async def infer_schema(self, scraped_data: ScrapedDataDict) -> DatabaseSchemaDict:
        try:
    ...
    def _build_schema_prompt(self, scraped_data: ScrapedDataDict) -> str:
        return f"""
